...
RECEIVERS:
    ...
    IF_RECEIVER(   setRecordingDirectory(const QString &dir, const recordingTemplate_t &templ)    )
...
SENDERS:
    ...
    IF_SENDER  (   notifyRecordingDirectoryChanged(const QString &dir, const recordingTemplate_t &filenameTemplate)    )
...
ANSWERS:
    ...
    IF_ANSWER  (   void                           getRecordingDirectory(QString &dir, recordingTemplate_t &templ) const    )
...
SENDERS:
    ...
    IF_SENDER  (   sendRecordingDirectory(const QString &dir, const recordingTemplate_t &filenameTemplate)    )
...
RECEIVERS:
    ...
    IF_RECEIVER(   noticeRecordingDirectoryChanged(const QString &dir, const recordingTemplate_t &filenameTemplate)    )
...
QUERIES:
    ...
    IF_QUERY   (   void                           queryRecordingDirectory(QString &dir, recordingTemplate_t &templ)    )
