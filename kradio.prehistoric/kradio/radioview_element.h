...
public:
	...
	bool connect   (Interface *) { return false; }   // default behaviour, please overwrite in derived class
	bool disconnect(Interface *) { return false; }   // default behaviour, please overwrite in derived class
