...
class KRadioAboutWidget::Private
{
public:
    Private(KRadioAboutWidget *parent)
        : q(parent),
          aboutData(0)
    {}
...
KRadioAboutWidget::KRadioAboutWidget(const KAboutData *aboutData, QWidget *parent)
  : QWidget(parent),
    d(new Private(this))
{
    if (aboutData == 0)
...
void KRadioAboutWidget::Private::_k_showLicense( const QString &number )
{
